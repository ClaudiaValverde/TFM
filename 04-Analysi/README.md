...
- `Retrospective_Analisis.ipynb`: validation, SaScore and other Physicochemical Properties for the generated SMILES in the Specific CDK2 and RET targets. Input files found in the folder.
