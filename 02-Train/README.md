...
Once the different represntations have been preprocessed, they can be input to the training script `main_code.py`, always 1 type of protein representation either 1) ESM2, 2) SaProt or 3) TendorDTI protein or pocket representation 1) PickPocket or 2) TensorDTI pocket.
